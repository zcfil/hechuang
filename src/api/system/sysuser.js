...
export function getSecretCode() {
  return request({
    url: '/api/v1/user/getVerificationCode',
    method: 'get'
  })
}

// 绑定谷歌验证码
export function bindVerification(googleSecret, code) {
  const data = {
    googleSecret,
    code
  }
  return request({
    url: '/api/v1/user/bindVerificationCode',
    method: 'post',
    data: data
  })
}
