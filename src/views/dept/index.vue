        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="负责人" prop="leader">
              <el-input v-model="form.leader" placeholder="请输入姓名、用户名、手机号查找" @input="chang" maxlength="20" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
  ...
  methods: {
    ...
    chang() {
        if(this.form.leader.length!='') {
            userList({keyword:this.form.leader}).then(res=> {
                this.arr=res.list
    ...
    choice(item) {
      this.form.leader=item.nick_name
      this.form.leaderID=parseInt(item.userid)
      this.show=false
    },
    /** 提交按钮 */
    submitForm: function() {
