<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="exchangeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="支付CXC数量" align="center" prop="amount" />
      <el-table-column label="幸运号码" align="center" prop="luckyNumber" />
...
<script>
import { listExchange, exportExcel } from '@/api/exchanges/exchanges'
  ...
  methods: {
    ...
    getList() {
      ...
      listExchange(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
        this.exchangeList = response.data.list
