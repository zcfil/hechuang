<template>
  <div class="app-container">
    ...
    <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="68px">
      <el-form-item label="UID" prop="cid">
        <el-input
    ...
    <el-table v-loading="loading" :data="releaseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="释放数量" align="center" prop="quantity" />
      <el-table-column label="备注" align="center" prop="remark" :show-overflow-tooltip="true" />
      <el-table-column label="释放时间" align="center" prop="time" width="180">
...
<script>
import { listRelease, exportExcel } from '@/api/exchanges/release'
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      listRelease(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
