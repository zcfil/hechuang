  ...
  <div class="app-container">
    <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="68px">
      <el-form-item label="参数名称" prop="title">
        <el-input
          v-model="queryParams.configTitle"
          placeholder="请输入参数名称"
          clearable
          size="small"
          style="width: 240px"
      ...
      <el-form-item label="参数类型" prop="group">
        <el-select v-model="queryParams.configGroup" placeholder="选择参数类型" clearable size="small">
          <el-option
    ...
    <el-table v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="参数名称" align="center" prop="title" :show-overflow-tooltip="true" />
      ...
      <el-table-column label="参数类型" align="center" prop="group" /> <!--:formatter="typeFormat" -->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="参数名称" prop="title">
          <el-input v-model="form.title" placeholder="请输入参数名称" />
        </el-form-item>
        ...
        <el-form-item label="数据类型" prop="type">
          <el-input v-model="form.type" placeholder="请输入参数数据类型" />
        </el-form-item>
        <el-form-item label="参数类型" prop="group">
          <el-select
            v-model="form.group"
...
export default {
  ...
  created() {
    this.getList()
    this.getDicts('sys_config_gruop').then(response => {
